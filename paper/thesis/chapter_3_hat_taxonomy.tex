...
\begin{table}[t]
    ...
    \begin{tabular}{lcc}
        ...
        Train: Proportional & $\sim$10\,\% & 97.37\,\% \\
        \bottomrule
    \end{tabular}
\end{table}

\section{Literature comparison: where this framework sits}
