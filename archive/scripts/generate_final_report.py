...
def main():
    raise SystemExit(
        "generate_final_report.py is stale after the 2026-04-23 dual-bug "
        "invalidation. Do not use it until it is rebuilt from post-fix R1/R2 "
        "artifacts and the corrected energy-scale JSON. See "
