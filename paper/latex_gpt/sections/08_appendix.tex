...
Table~\ref{tab:v4-three-seed-summary} summarizes protocol-matched fresh-instance reproducibility across three Ensemble HAT training seeds under the canonical regime.
...
Table~\ref{tab:sensitivity} validates the Zhang 2025 OPECT proxy estimates via 2D noise sweep.
...
Table~\ref{tab:retention-comparison} compares uniform and state-dependent retention decay.
