"""
Pythia-1B last1 eval launcher.
Evaluates p1b_last1_d2d002_seed42 under standard D2D=0.02 conditions.
"""
...
CKPT = "/home/lisq753/projects/HAT_kv107/paper2/results/remote107/checkpoints/p1b_last1_d2d002_seed42"
...
def main():
    print(f"[P1B] Starting {len(EVAL_JOBS)} eval jobs...")
    active = {}
    completed = []
    ...
    print(f"[P1B] Complete. {len(completed)} eval jobs finished.")
