...
The old 2026-05-01 6-bit protocol artifacts are preserved under `deprecated_20260501_old_protocol/` and are not active release evidence. The corrected 6-bit seed123 rerun is complete as of 2026-05-09 and includes `training_history.json`, `fresh_eval.json`, and `drift_eval.json`.
