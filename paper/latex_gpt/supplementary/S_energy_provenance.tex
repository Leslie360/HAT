...
\bottomrule
\end{tabular}
\caption{Provenance of energy-model constants. Literature proxies and order-of-magnitude estimates are used for relative comparison, not routed-circuit prediction.}
