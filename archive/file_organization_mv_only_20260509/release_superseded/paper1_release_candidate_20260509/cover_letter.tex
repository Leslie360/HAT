...
\begin{enumerate}
    ...
    \item A PCM precision ladder showing 8-bit drift-flat behaviour, trainable but drift-limited 4-bit behaviour, and a 6-bit D2D-sensitive transition regime in the tested UnitCell sweep.
