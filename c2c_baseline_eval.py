"""
C2C baseline eval for last1 checkpoint.
Evaluates k107_a1_last1_seed42 under C2C=0.01 and C2C=0.02.
"""
...
OUT_DIR = "/home/lisq753/projects/HAT/HAT/deliverable/results_v3/c2c_baseline"
CKPT = "/home/lisq753/projects/HAT_kv107/paper2/results/remote107/checkpoints/k107_a1_last1_seed42"

os.makedirs(OUT_DIR, exist_ok=True)

EVAL_JOBS = [
    # (tag, sigma_c2c, sigma_d2d, eval_seed)
    ("c2c001", 0.01, 0.02, 42),
    ("c2c001", 0.01, 0.02, 123),
    ("c2c001", 0.01, 0.02, 456),
    ("c2c002", 0.02, 0.02, 42),
    ("c2c002", 0.02, 0.02, 123),
    ("c2c002", 0.02, 0.02, 456),
]
...
def main():
    print(f"[C2C] Starting {len(EVAL_JOBS)} eval jobs...")
    active = {}
    completed = []
    ...
    print(f"[C2C] Complete. {len(completed)} eval jobs finished.")
