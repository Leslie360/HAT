...
For reference, the four empirical baselines against which the extensions in this chapter are judged are: (i)~Ensemble HAT preserves $86.37\pm1.54\,\%$ fresh-instance accuracy under canonical uniform noise; (ii)~the canonical V4 fixed-mask checkpoint reaches $87.95\pm0.27\,\%$ source-domain accuracy but collapses to $10.00\,\%$ on fresh instances; (iii)~global severe write nonlinearity ($NL=2.0$) drives the unmitigated baseline to $27.72\pm0.82\,\%$; and (iv)~MLP-only linearization rescues source-domain accuracy to $87.79\,\%$ yet caps at $32.12\pm7.72\,\%$ on fresh instances.
...
\begin{itemize}[leftmargin=1.4em]
    ...
    \item The MLP-only diagnostic bound ($32.12\pm7.72\,\%$ fresh-instance ceiling) and the all-linear bound ($87.49\,\%$ best / $84.81\,\%$ final, $32.60\pm9.18\,\%$ fresh-instance) could both be \emph{worsened} by heavy-tailed mismatch or IR drop, because both extensions increase the variance of the effective weights beyond the Gaussian baseline that produced the $32\,\%$ ceiling.
