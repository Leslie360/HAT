...
- Generated: `2026-04-19T02:44:02.601771`
- Checkpoint: `checkpoints/_ensemble/V4_hybrid_standard_noise_hat_best.pt`
- Protocol: `10 fresh D2D instances x 5 MC evaluations per instance on the canonical Tiny-ViT V4 Ensemble HAT checkpoint`
- Correlation model: `separable_ar1_2d`

| Condition | Train best acc (%) | Fresh-instance mean (%) | Cross-instance std (%) |
|:--|--:|--:|--:|
| iid Gaussian | 91.13 | 86.33 | 1.61 |
| correlated rho=0_3 | 91.13 | 84.57 | 2.39 |
| correlated rho=0_5 | 91.13 | 82.12 | 3.95 |
