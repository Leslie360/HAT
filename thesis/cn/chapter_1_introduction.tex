...
\begin{enumerate}
    ...
    但 fresh-instance 迁移仍停留在~$32.60\pm9.18\%$；对应的非线性缓解与 fresh-instance 控制实验记录在论文源数据的 JSON 汇总文件中。
\end{enumerate}
...
MLP-only 线性补偿可达~$87.79\%$，全线性补偿可达~$87.49\%$（见 NL 缓解汇总记录），
而 fresh-instance 迁移仍停留在~$32.60\pm9.18\%$（见 NL fresh-instance 控制评估记录）。
