...
\midrule
 ...
 Cycle-to-Cycle Noise (\(\sigma_{c2c}\)) & 5\% & 2\% & 5\% (Proportional) & Zhang 2026 value is a proxy estimate from 8-cycle repeatability (Supp.Fig.15). Proportional stress scales \(\sigma \propto |G|\). \\ 
