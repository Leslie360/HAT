...
def _scaled_noise_from_reference(noise_source: torch.Tensor,
    ...
    if mode == "proportional":
        # NOTE: In proportional mode, sigma is a noise-to-signal ratio, NOT
        # an absolute standard deviation. Zero signal → zero noise.
        # Full-range signal → σ × |value|. Semantic differs from uniform mode.
        eps = 1e-8
