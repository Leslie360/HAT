...
# KIMI Rebuttal Master Index — 2026-04-21 (v3)

**Scope:** Consolidated, deduplicated index of all anticipated reviewer objections across five source documents plus CX-J1 definitive negative result and v3 anticipation defense.
**Constraint:** Reference document; bullet-heavy, scannable. PM should find any objection in <10 s.
**Narrative pivot:** The original joint-training hypothesis (≥80 % recovery) was falsified at 30.53 ± 7.07 %; the thesis reframes this as a structural-limit discovery supported by three converging mitigations.
...
|--------|-------|----------|--------------|------|--------|
| OBJ-thesis-punchline | Joint-training ceiling falsifies the ≥80 % recovery claim | Yes | No | P0 | CX-J1 |
| OBJ-falsification | Negative result is rigorous falsification, not a failed experiment | Yes | No | P0 | CX-J1 |
...
| OBJ-28 | How can a negative result be novel? | Yes | No | P0 | ANTICIPATION_V3 |
| OBJ-29 | Practical value of knowing what doesn't work | Yes | No | P0 | ANTICIPATION_V3 |
| OBJ-30 | Is the 30 % ceiling real or a simulator artifact? | Yes | No | P0 | ANTICIPATION_V3 |
| OBJ-31 | Attention pathway vs. other mechanisms | Partial | Yes | P1 | ANTICIPATION_V3 |
| OBJ-32 | The paper feels pessimistic | Yes | No | P0 | ANTICIPATION_V3 |

---

## 2. Deduplicated Objections

### OBJ-thesis-punchline — Joint-training ceiling falsifies the ≥80 % recovery claim
- **Objection:** The thesis claimed joint training would recover ≥80 %, but CX-J1 fresh-instance joint training only reached 30.53 ± 7.07 %—indistinguishable from MLP-only (32.12 ± 7.72 %) and all-linear (32.60 ± 9.18 %). This looks like the central hypothesis failed.
- **Response:** The original hypothesis was falsified, and the thesis was updated to frame this as a structural-limit discovery. Three independent mitigations—MLP-only analog, all-linear analog, and joint-training analog—converge on the same ~30 % ceiling, which is stronger evidence for a structural bottleneck than a single optimization success would have been.
- **Pointer:** §5.10 (new CX-J1 subsection), §6.2, §6.6. No new experiment needed; result is definitive.
- **Cross-links:** OBJ-falsification, OBJ-23

### OBJ-falsification — A negative result is not a failed experiment
- **Objection:** Isn't a negative result just a failed experiment? Why should reviewers accept a paper whose headline mitigation did not work?
- **Response:** No. A pre-registered hypothesis test with three independent negative outcomes that converge on the same ceiling constitutes rigorous falsification. This is Popperian science, not a fishing expedition. The paper's contribution shifted from "here is a recipe that works" to "here is a precisely bounded structural limit and three converging lines of evidence that pin it."
- **Pointer:** §1 (updated framing sentence), §5.10, §6.6. No experiment needed.
- **Cross-links:** OBJ-thesis-punchline
...
- **Response:** Group-wise ablation localizes failure to specific blocks while keeping training tractable, and §6.5 does not overstate it as factorial. Both attention-side linearizations collapse independently, so their fragility does not depend on MLP noise; 2³ factorial is future work. **Updated:** The CX-J1 joint-training result (30.53 ± 7.07 %) empirically confirms that simultaneous attention+MLP perturbation does not unlock hidden synergy; the ceiling is structural, not interactional.
- **Pointer:** §5.10, §6.5. Experiment: factorial joint-perturbation ablation (now supported by CX-J1 convergence evidence).
- **Cross-links:** OBJ-thesis-punchline
...
### OBJ-28 — How can a negative result be novel?
- **Objection:** How can a negative result be novel?
- **Response:** Three independent mitigations converging on the same ~30 % ceiling provide stronger evidence for a structural bottleneck than any single positive optimization success could. This falsifies the intuitive hypothesis that joint training automatically recovers analog-induced accuracy loss, a belief the field would otherwise continue to assume.
- **Pointer:** §5.10, §6.6. No experiment needed.
- **Cross-links:** OBJ-thesis-punchline, OBJ-falsification, OBJ-30

### OBJ-29 — What is the practical value of knowing what doesn't work?
- **Objection:** What is the practical value of knowing what doesn't work?
- **Response:** Knowing that first-order joint-training surrogates fail at severe NL saves the field from wasting GPU-hours on futile optimization campaigns. It redirects research effort toward higher-order training surrogates or architectural modifications that are more likely to overcome the analog ceiling.
- **Pointer:** §1, §6.6. No experiment needed.
- **Cross-links:** OBJ-thesis-punchline, OBJ-28

### OBJ-30 — Is the 30 % ceiling real or just an artifact of your simulator?
- **Objection:** Is the 30 % ceiling real or just an artifact of your simulator?
- **Response:** CrossSim framework validation, the explicit first-order scope of the NL surrogate, and the convergence of three independent mitigation strategies on the same numerical bound all support the ceiling's reality. A single simulator artifact would not reproduce identically across MLP-only, all-linear, and joint-training configurations.
- **Pointer:** §3.3, §5.10, §6.6. No experiment needed.
- **Cross-links:** OBJ-thesis-punchline, OBJ-28

### OBJ-31 — How do you know it's the attention pathway and not something else?
- **Objection:** How do you know it's the attention pathway and not something else?
- **Response:** The parameter-budget analysis in G-FF1 shows attention blocks dominate analog weight count, while gradient-flow analysis localizes collapse to QKV and projection lanes. Planned CX-J1b/c/d diagnostics will provide further mechanistic confirmation that the attention pathway is the primary fragility source.
- **Pointer:** §5.10, §6.2, G-FF1. Experiment: CX-J1b/c/d gradient-flow diagnostics.
- **Cross-links:** OBJ-11, OBJ-12

### OBJ-32 — The paper feels pessimistic
- **Objection:** The paper feels pessimistic.
- **Response:** The paper is realistic because Ensemble HAT at NL=1.0 achieves a 76 percentage-point recovery. The negative result is explicitly scoped to severe nonlinearity (NL=2.0), a specific edge case that defines a structural bound rather than a universal verdict on analog transformers.
- **Pointer:** §1, §5.8, §5.10. No experiment needed.
- **Cross-links:** OBJ-thesis-punchline, OBJ-10
...
| **F — Joint-training falsification** | OBJ-thesis-punchline, OBJ-falsification, OBJ-23 | CX-J1 negative result; 30 % ceiling; three converging mitigations |
| **G — Negative-result defense** | OBJ-28, OBJ-29, OBJ-30, OBJ-32 | 30 % ceiling; practical value; simulator independence; tone correction |
| **H — Attention-pathway localization** | OBJ-31, OBJ-11, OBJ-12 | G-FF1 parameter budget; gradient-flow; QKV/projection collapse |

---

## 4. P0 (Critical) — Pre-empt in manuscript or cover letter now

- **OBJ-thesis-punchline** — Add one sentence to §1 and §5.10: the thesis hypothesis was pre-registered, falsified at 30 %, and reframed as a structural-limit discovery. Three converging mitigations (MLP-only, all-linear, joint-training) now pin the ceiling.
- **OBJ-falsification** — Add one sentence to §1 or cover letter: three independent negative outcomes converging on the same ceiling constitute rigorous Popperian falsification, not a failed experiment.
...
- **OBJ-28** — Add one sentence to §1 or §5.10 framing three converging negative outcomes as stronger falsification evidence than a single positive result, directly addressing novelty-of-negative-result concerns.
- **OBJ-29** — Add one sentence to §6.6 or cover letter stating that boundary-setting negative results save the field from futile GPU-hour expenditure and redirect effort toward viable alternatives.
- **OBJ-30** — Add one sentence to §5.10/§6.6 noting CrossSim validation and triple-convergence as independent evidence against a simulator-artifact explanation of the 30 % ceiling.
- **OBJ-32** — Add one sentence to §1 or cover letter clarifying that the negative result is scoped to NL=2.0 and that the 76 pp NL=1.0 recovery is foregrounded as the operational success case.

---

## 5. P1 (Important) — Keep in response letter

OBJ-04, OBJ-06, OBJ-07, OBJ-08, OBJ-10, OBJ-11, OBJ-12, OBJ-13, OBJ-14, OBJ-15, OBJ-20, OBJ-23, OBJ-24, OBJ-26, OBJ-31
...
|--------|-------|
| **Total objections** | 34 |
| **Covered in manuscript (Yes + Partial)** | 34 / 34 (100 %) |
| **Covered in manuscript (Yes only)** | 15 / 34 (44 %) |
| **Needing new experiments** | 15 / 34 (44 %) |
| **Median response length** | 36 words |
| **P0 / P1 / P2 split** | 11 / 15 / 8 |

---

*Generated: 2026-04-21*
*Sources: CLAUDE_REBUTTAL_PREP_20260420.md, KIMI_REBUTTAL_ARSENAL_V1_20260420.md, KIMI_REBUTTAL_ARSENAL_V2_STATS_20260420.md, KIMI_REBUTTAL_ARSENAL_V2_METHODS_20260420.md, KIMI_REBUTTAL_ARSENAL_V2_GEN_20260420.md, CX-J1 definitive negative result, ANTICIPATION_V3*
