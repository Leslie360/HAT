...
第~5~章报告了该假设的证伪结果：
三项独立训练干预在严重非线性（nonlinearity, NL）条件下均收敛于约~$32.6\%$~的全新实例精度（第~5~章），
...
\begin{enumerate}
    ...
    但 fresh-instance 迁移仍停留在~$32.60\pm9.18\%$（第~5~章）。
\end{enumerate}
...
MLP-only 线性补偿可达~$87.79\%$，全线性补偿可达~$87.49\%$（第~5~章），
而 fresh-instance 迁移仍停留在~$32.60\pm9.18\%$（第~5~章）。
