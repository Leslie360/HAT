...
run_job() {
  ...
  local d2d="$3"
  local c2c="$4"
  local name="w2_llm_scope_${scope}_${tag}_r10_lr5e6_lb200_${RUN_ID}"
...
run_job qkv n010005 0.01 0.005
sleep 5
run_job qkv n020010 0.02 0.010
sleep 5
run_job mlp n010005 0.01 0.005
sleep 5
run_job mlp n020010 0.02 0.010
sleep 5
run_job attention_output n020010 0.02 0.010
sleep 5
run_job qkv_attention n010005 0.01 0.005
while true; do
  date '+[monitor] %F %T'
